...
module Curses
  ...
  BUTTON1_DOUBLE_CLICKED = 0x8 unless defined?(BUTTON1_DOUBLE_CLICKED)
  BUTTON1_TRIPLE_CLICKED = 0x10 unless defined?(BUTTON1_TRIPLE_CLICKED)

  BUTTON2_PRESSED = 0x80 unless defined?(BUTTON2_PRESSED)
  BUTTON2_RELEASED = 0x40 unless defined?(BUTTON2_RELEASED)
  BUTTON2_CLICKED = 0x100 unless defined?(BUTTON2_CLICKED)

  BUTTON3_PRESSED = 0x2000 unless defined?(BUTTON3_PRESSED)
  BUTTON3_RELEASED = 0x1000 unless defined?(BUTTON3_RELEASED)
  BUTTON3_CLICKED = 0x4000 unless defined?(BUTTON3_CLICKED)

  BUTTON4_PRESSED = 0x80000 unless defined?(BUTTON4_PRESSED)    # スクロール上
  BUTTON5_PRESSED = 0x8000000 unless defined?(BUTTON5_PRESSED)   # スクロール下
